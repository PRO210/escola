...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12" >
                    <h3>Disciplinas Desativadas</h3>
                    <?php
                    $Consulta = mysqli_query($Conexao, "SELECT * FROM `disciplinas` WHERE excluido = 'S' ORDER BY disciplina");
                   ...
                   // . "<button type ='submit' name ='exclui_disciplinas' value = 'exclui_disciplinas' onclick='return validaCheckbox()' class = 'btn btn-success' title = 'Reativar Disciplina' ><span title= 'Exclui Varias Disciplinas' class='glyphicon glyphicon-remove btn-lg vermelho' aria-hidden='true'></span></button>"
                   // . "</th>";

                    echo "<th>DISCIPLINAS </th>";
                    // echo "<th> Professor 01 </th>";
                    // echo "<th> Professor 02 </th>";
                    //  echo "<th> Professor 03 </th>";
                    echo "</tr>";
                    echo "</thead>";
                    echo "<tbody>";
                    ...
                    if ($row > 0) {
                        ...
                        while ($linha = mysqli_fetch_array($Consulta)) {
                            ...
                            //$prof1 = $linha['professor1'];
                            // $prof2 = $linha['professor2'];
                            // $prof3 = $linha['professor3'];
