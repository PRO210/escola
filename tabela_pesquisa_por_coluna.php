...
<html lang="pt-br">
    <head>
        ...
        <title>TABELA PESQUISA POR COLUNA</title>        
    </head>   
    <body>
        <?php
        ...
        <div class="container-fluid" >          
            <h3 style="text-align: center">TABELA PESQUISA POR COLUNA</h3>
            ...
            <link href="css/tabela_pesquisa_por_coluna.css" rel="stylesheet" type="text/css"/>
            <?php
            ...
            $Consultaf = mysqli_query($Conexao, "SELECT *, TIMESTAMPDIFF(YEAR,data_nascimento,data_valida_matricula) AS idade FROM alunos WHERE `nome` LIKE '%" . $buscarf_nome . "%' AND (status = 'CURSANDO' OR status = 'ADIMITIDO DEPOIS') AND excluido = 'N' ORDER BY nome");
            ...
            . "&nbsp;&nbsp;<a href='cadastrar.php' target='_self' class='btn btn-success' >Cadastrar Novato</a>"
            . "&nbsp;&nbsp;<a href='cadastrar_transferido.php' target='_self' class='btn btn-success' >Cadastrar Transferido</a>"
            ;
            ?> ",
