...
//$ConsultaV = mysqli_query($Conexao, "SELECT * FROM turmas WHERE turno = 'MATUTINO' AND `ano` LIKE '$ano%' ORDER BY turma ");
//$rowV = mysqli_num_rows($ConsultaV);
////
//while ($linhaV = mysqli_fetch_array($ConsultaV)) {
//    $idV = $linhaV['id'];
...
//    $turma = "$turmaV ($turnoV)";
//    //
//    $ConsultaQtd = mysqli_query($Conexao, "SELECT COUNT(*) AS AM FROM alunos WHERE turma LIKE '" . $idV . "' ");
//    $rowqtd = mysqli_fetch_array($ConsultaQtd);
//    $am = $rowqtd['AM'];
//    //
//    $ids = "";
//    $Consulta = mysqli_query($Conexao, "SELECT * FROM alunos WHERE turma LIKE '$idV'  ORDER BY nome ");
//    while ($Linha = mysqli_fetch_array($Consulta)) {
//
//        $id = $Linha['id'];
//        $ids .= "$id,";
...
//        $funcao_professor = $Linha_Professor["funcao"];
//        $nome_professor = $Linha_Professor["nome"];
//        $nome_professores .= "$nome_professor" . " - " . $funcao_professor . " <br> ";
//    }
//    $Cadastrar_turma = "INSERT INTO turma_backup (`id_turma`, `matriculados`, `transferidos`, `admitidos`, `desistentes`, `cursando`, `ano`,`ids`,`prof`) "
//            . "VALUES (  '$idV' , '$am', '$at','$ad','$adesis','$ac','$ano','$todos_ids','$nome_professores')";
//    $Consulta_turma = mysqli_query($Conexao, $Cadastrar_turma);
//}
//
////
