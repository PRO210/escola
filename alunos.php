...
//<button type='button' class='btn btn-link' data-toggle='modal' data-target='#myModal_Servidores'></button>
            // echo "<button type='button' class='btn btn-link' data-toggle='modal' data-target='#myModal_Turmas' id = 'esconder_list'><span class='glyphicon glyphicon-cog text-success btn-lg' id='dropdownMenu1' data-toggle='dropdown' aria-haspopup='true' aria-expanded='true'></span></button>";
...
//
                    ...
                    . "<li style = 'display:$visao_boleto '><a href='boleto_cadastrar.php?id=" . base64_encode($idf) . "' target='_blank' title='Boleto'><span class='glyphicon glyphicon-piggy-bank' aria-hidden='true'>&nbsp;</span>Boletos</a></li>"
                    . "</ul>"
                    . "&nbsp;&nbsp;$nomef"
                    . "</div>"
                    . "</td>\n";
