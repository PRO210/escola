                ...
                <div class="col-sm-12">
                    ...
                    <form method="post" action="atualizar_varios.php" name="form1" >
                        <table id="" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($arrayTurmas as $idturma) {
                                    $Consulta2 = mysqli_query($Conexao, "SELECT s.nome,s.substituta,s.projeto,s.projeto_nome FROM `turmas_professor2` tr, servidores s WHERE id_turma = $idturma  AND tr.id_professor = s.id");
                                    echo "<td>";
                                    $nomeProfessores = "";
                                    //
                                    while ($linhaConsulta = mysqli_fetch_array($Consulta2, MYSQLI_BOTH)) {

                                        $substituta = $linhaConsulta["substituta"];
                                        $teste_folga = "";
                                        ...
                                        $projeto = $linhaConsulta["projeto"];
                                        if ($projeto == "SIM") {
                                            $projeto_nome = " - " . $linhaConsulta["projeto_nome"];
                                        } else {
                                            $projeto_nome = "";
                                        }
                                        $nomeProfessores .= $linhaConsulta['nome'] . $teste_folga . $substituta . $projeto_nome . '<br>';
                                    }
                        ...
                        foreach ($arrayTurmasN as $idturma) {
                            ...
                            $Consulta2 = mysqli_query($Conexao, "SELECT s.nome,s.substituta,s.projeto,s.projeto_nome FROM `turmas_professor2` tp, servidores s WHERE id_turma = '" . $idturma . "' AND tp.id_professor = s.id");
                            echo "<td>";
                            $nomeProfessores = "";
                            while ($linhaConsulta = mysqli_fetch_array($Consulta2, MYSQLI_BOTH)) {
